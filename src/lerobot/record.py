...
from lerobot.policies.ppo.ppo import PPO_Policy
...
def record_loop(
    ...
    while timestamp < control_time_s:
        ...
        if policy is not None or dataset is not None:
            dataset.features["observation.vel"] = {
                "dtype": "float32", 
                "shape": (6,), 
                "names": ['shoulder_pan.vel', 'shoulder_lift.vel', 'elbow_flex.vel', 'wrist_flex.vel', 'wrist_roll.vel', 'gripper.vel']
            }
        ...
        if policy is not None:
            ...
            action = robot.normalize_pos(action,radians=True)
...
#   --policy.path=src/lerobot/record.py
